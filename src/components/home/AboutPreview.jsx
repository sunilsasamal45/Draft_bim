      ...
      <Container className="relative">
        <div className="grid items-center gap-12 lg:grid-cols-[.92fr_1.08fr] lg:gap-16">
          ...
          >
            ...
            <h2 className="mt-4 text-4xl font-extrabold leading-[1.08] tracking-[-.055em] text-ink sm:text-5xl">
            ...
            <a
              ...
              className="group mt-9 inline-flex items-center gap-2 rounded-md bg-ink px-6 py-3 text-sm font-extrabold text-white transition hover:bg-brand"
            >
              Discuss Your Project <ArrowRight size={16} className="transition-transform duration-300 group-hover:translate-x-1" />
            </a>
          </motion.div>

          {/* Right — image + founder badge */}
          <motion.div
